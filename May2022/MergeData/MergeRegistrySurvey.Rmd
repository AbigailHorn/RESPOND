---
title: "Merge Registry and Survey Data"
...
d <- merge(x=d, y=disease_characteristics, by.x="respondid", by.y="d.respondid", all.x=FALSE, all.y=FALSE)
...
save(d, file=paste("../Data/vmerged_", format(Sys.time(), "%Y%m%d"), ".Rda", sep=""))
write.table(d, file=paste("../Data/vmerged_", format(Sys.time(), "%Y%m%d"), ".csv", sep=""), sep=",", quote=F, row.names=F)
```
