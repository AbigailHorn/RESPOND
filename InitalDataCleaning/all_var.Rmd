...
## All data
```{r rxdatesurgery, message=FALSE, results='asis'}
st_css() #IMPORTANT!
...
## All data
```{r rxdateradiation, message=FALSE, results='asis'}
st_css() #IMPORTANT!
...
## All data
```{r rxdatechemo, message=FALSE, results='asis'}
st_css() #IMPORTANT!
...
## All data
```{r rxdatehormone, message=FALSE, results='asis'}
st_css() #IMPORTANT!
...
## All data
```{r rxdatebrm, message=FALSE, results='asis'}
st_css() #IMPORTANT!
...
## All data
```{r rxdateother, message=FALSE, results='asis'}
st_css() #IMPORTANT!
...
## All data
```{r dateinitialrxseer, message=FALSE, results='asis'}
st_css() #IMPORTANT!
...
## All data
```{r rxdatedxstgproc, message=FALSE, results='asis'}
st_css() #IMPORTANT!
...
## All data
```{r dateoflastcontact, message=FALSE, results='asis'}
st_css() #IMPORTANT!
  dateoflastcontact <- as.factor(d[,"dateoflastcontact"])
  
    new.d <- data.frame(new.d, dateoflastcontact)
    new.d <- apply_labels(new.d, dateoflastcontact = "date_of_last_contact")
    #summary(new.d$dateoflastcontact)
temp.d <- data.frame (new.d.1, dateoflastcontact)
summarytools::view(dfSummary(new.d$dateoflastcontact, style = 'grid', max.distinct.values = 50, plain.ascii = FALSE, valid.col = FALSE, headings = FALSE ), method = "render")
```
## LA County
...
## All data
```{r survdateactivefollowup, message=FALSE, results='asis'}
st_css() #IMPORTANT!
...
## All data
```{r survdatepresumedalive, message=FALSE, results='asis'}
st_css() #IMPORTANT!
...
## All data
```{r survdatedxrecode, message=FALSE, results='asis'}
st_css() #IMPORTANT!
...
## All data
```{r rxdatemostdefinsurg, message=FALSE, results='asis'}
st_css() #IMPORTANT!
...
## All data
```{r rxdatesystemic, message=FALSE, results='asis'}
st_css() #IMPORTANT!
